---
# layout: post
title: "[ML] How to explanin ML results"
categories:
 - ML/DL
tags: 
 - ML
...
- 해당 글은 Dell의 Data Science Factory 팀의 일원이 작성한 글으로, 데이터 기반의 솔루션을 제시할 때 explanation이 필요하다는 점에서 제시한 방법들이다. 위의 글을 번역 및 정리한 내용이다.
...
- 어떠한 모델으로 분석을 진행하는지에 상관없이, linear model을 사용하여 해석을 제공한다.
    - linear model은 복잡한 데이터 혹은 모델은 설명하지 못할 수 있지만, local observation에 한해서는 적절한 설명을 제공할 것이다. → 관련 내용은 이 [논문](https://arxiv.org/abs/1602.04938)에서 더 자세히 확인할 수 있다.
        ...
        > 
- 원래 데이터 셋을 사용하여 설명하고자 하는 관찰값 주변의 데이터들을 샘플링하는 방식을 사용한다.
...
![https://miro.medium.com/max/553/1*3miawSbi8YO-tbCIxthEVw.png](https://miro.medium.com/max/553/1*3miawSbi8YO-tbCIxthEVw.png)
...
- 결과에 대한 해석은 다음과 같다.
    ...
    ![https://miro.medium.com/max/700/1*YZ9A1Hf8qNIEi6XU5Wxz3A.png](https://miro.medium.com/max/700/1*YZ9A1Hf8qNIEi6XU5Wxz3A.png)
...
- 결과는 다음과 같다.
    ...
    ![https://miro.medium.com/max/693/1*aeZ0vMcN4dlKs0MmMY2M9w.png](https://miro.medium.com/max/693/1*aeZ0vMcN4dlKs0MmMY2M9w.png)
...
- class에 따른 feature의 behavior을 확인할 수도 있다. 이를 위해 가장 먼저, test set에 대해 SHAP vlaue를 계산한다.
    ...
    ![https://miro.medium.com/max/696/1*4nhDnnXFX-qfsGr0u7lDDw.png](https://miro.medium.com/max/696/1*4nhDnnXFX-qfsGr0u7lDDw.png)
...
- Global explanation을 확인하려면 다음과 같이 실행한다.
    ...
    ![https://miro.medium.com/max/1050/1*vYrB-8kSb9x2e9zO4J25FA.gif](https://miro.medium.com/max/1050/1*vYrB-8kSb9x2e9zO4J25FA.gif)
...
- Local explanation은 다음과 같이 확인한다.
    ...
    ![https://miro.medium.com/max/1050/1*_4EDLj3n9u5BCXQKjnhj1A.gif](https://miro.medium.com/max/1050/1*_4EDLj3n9u5BCXQKjnhj1A.gif)
...
- Local explanation을 확인한다.
    ...
    ![https://miro.medium.com/max/1050/1*MkrliqUd-OCjUUgXYzdVwA.gif](https://miro.medium.com/max/1050/1*MkrliqUd-OCjUUgXYzdVwA.gif)
...
- InterpretML package는 blackbox 모델에 대해서는 위와 같은 설명을 제공하지 않기 때문에 LIME과 SHAP를 활용하였다.
    ...
    ![https://miro.medium.com/max/1050/1*PqqoW1uzpG2gjVD2yunpIA.gif](https://miro.medium.com/max/1050/1*PqqoW1uzpG2gjVD2yunpIA.gif)
